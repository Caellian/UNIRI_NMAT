...
\begin{examplebox}[uporaba lagrangeovog polinoma]
...
Interpolacija lagrangeovim polinomom zahtjeva $\mathcal{O}(n^2)$ operacija kod prvog izvrjednjavanja i $\mathcal{O}(n)$ operacija za svako sljedeće izvrjednjavanje.
